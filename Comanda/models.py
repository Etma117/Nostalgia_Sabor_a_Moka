...
class CarritoItem(models.Model):
    ...
    adicional = models.CharField(max_length=500, blank= True, null=True)
    totalextra = models.DecimalField(max_digits=10, decimal_places=2, default=0, blank=True, null=True)
    ...
    def calcular_subtotal(self):
        ...
        if self.adicional:
            subtotal += self.totalextra * self.cantidad
        return subtotal
